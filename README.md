...
下面是**严格按照《数字图像处理》（冈萨雷斯）经典教材章节**编排的**周项目/作业清单与模板**。每周作业包含**姓名、学号、实验题目、实验内容（代码）、数学推导（公式/理论）、实验结果、分析与总结**等模块，适合标准本科/研究生数字图像处理课程教学。

---

# 📙《数字图像处理》章节式课程项目(请用自己的人脸图像）[提交作业模板.docx](https://github.com/jinqijinqi/image-processing-course/blob/main/homework/%E4%BD%9C%E4%B8%9A%E6%A8%A1%E6%9D%BF.docx) <br/>
